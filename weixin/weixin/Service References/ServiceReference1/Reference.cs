...
// 
namespace weixin.ServiceReference1 {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface MobileCodeWSSoapChannel : weixin.ServiceReference1.MobileCodeWSSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MobileCodeWSSoapClient : System.ServiceModel.ClientBase<weixin.ServiceReference1.MobileCodeWSSoap>, weixin.ServiceReference1.MobileCodeWSSoap {
        ...
        System.IAsyncResult weixin.ServiceReference1.MobileCodeWSSoap.BegingetMobileCodeInfo(string mobileCode, string userID, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetMobileCodeInfo(mobileCode, userID, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string weixin.ServiceReference1.MobileCodeWSSoap.EndgetMobileCodeInfo(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetMobileCodeInfo(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((weixin.ServiceReference1.MobileCodeWSSoap)(this)).BegingetMobileCodeInfo(mobileCode, userID, callback, asyncState);
        }
        
        private object[] OnEndgetMobileCodeInfo(System.IAsyncResult result) {
            string retVal = ((weixin.ServiceReference1.MobileCodeWSSoap)(this)).EndgetMobileCodeInfo(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult weixin.ServiceReference1.MobileCodeWSSoap.BegingetDatabaseInfo(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BegingetDatabaseInfo(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string[] weixin.ServiceReference1.MobileCodeWSSoap.EndgetDatabaseInfo(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBegingetDatabaseInfo(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((weixin.ServiceReference1.MobileCodeWSSoap)(this)).BegingetDatabaseInfo(callback, asyncState);
        }
        
        private object[] OnEndgetDatabaseInfo(System.IAsyncResult result) {
            string[] retVal = ((weixin.ServiceReference1.MobileCodeWSSoap)(this)).EndgetDatabaseInfo(result);
            return new object[] {
                    retVal};
        }
        ...
        protected override weixin.ServiceReference1.MobileCodeWSSoap CreateChannel() {
            return new MobileCodeWSSoapClientChannel(this);
        }
        
        private class MobileCodeWSSoapClientChannel : ChannelBase<weixin.ServiceReference1.MobileCodeWSSoap>, weixin.ServiceReference1.MobileCodeWSSoap {
            
            public MobileCodeWSSoapClientChannel(System.ServiceModel.ClientBase<weixin.ServiceReference1.MobileCodeWSSoap> client) : 
                    base(client) {
            }
